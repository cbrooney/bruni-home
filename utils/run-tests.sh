...
# run locally
docker-compose -f docker-compose-db.yml -f docker-compose-dev.yml --env-file .env.local.docker-compose up -d
...
docker-compose -f docker-compose-dev.yml --env-file .env.local.docker-compose run php-fpm composer tests
docker-compose -f docker-compose-dev.yml -f docker-compose-db.yml --env-file .env.local.docker-compose down --remove-orphans
