...
# docker-compose -f docker-compose.yml -f docker-compose-db.yml --env-file .env.test up -d
...
docker-compose -f docker-compose.yml --env-file .env.test run php-fpm composer tests
...
docker-compose -f docker-compose.yml -f docker-compose-db.yml --env-file .env.test down
